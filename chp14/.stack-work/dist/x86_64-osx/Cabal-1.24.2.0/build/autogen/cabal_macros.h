...
/* package chp14-0.1.0.0 */
#define VERSION_chp14 "0.1.0.0"
#define MIN_VERSION_chp14(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "chp14-0.1.0.0"

#define CURRENT_PACKAGE_KEY "chp14-0.1.0.0"
