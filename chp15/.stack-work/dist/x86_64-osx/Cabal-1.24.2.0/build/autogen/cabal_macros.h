...
/* package chp15-0.1.0.0 */
#define VERSION_chp15 "0.1.0.0"
#define MIN_VERSION_chp15(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "chp15-0.1.0.0"

#define CURRENT_PACKAGE_KEY "chp15-0.1.0.0"
